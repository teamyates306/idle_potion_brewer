...
export default function Modal({ title, onClose, children, accent = "#a855f7" }: ModalProps) {
  return (
    <div
    ...
    >
      ...
      >
        <div
          className="sticky top-0 flex items-center justify-between border-b border-slate-700 bg-[#0f172a] px-4 py-3"
