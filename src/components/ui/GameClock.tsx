...
export default function GameClock() {
  ...
  return (
    <div
      className="pointer-events-none flex items-center gap-1.5 rounded-full border border-amber-800/50 bg-[#f4e9d0]/95 px-2.5 py-1 shadow-md lg:px-3.5 lg:py-1.5 lg:[&_svg]:h-4 lg:[&_svg]:w-4"
      title="Guild standard time — one day passes every 3 minutes"
    >
      <Clock size={12} className="text-amber-700" />
      <span className="text-[10px] font-bold tracking-wide text-amber-900 tabular-nums lg:text-xs">
