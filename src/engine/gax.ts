...
export const GAX_EVENTS: GaxEventDef[] = [
  { id: "frost_dragon", headline: "Frost dragon sighted circling Copperfen — hearth-fires selling out across the fen!",
  ...
  { id: "storm_festival", headline: "The Thunder Steppe's storm has RSVP'd to Frostgate's kite festival. Shock wardings up wildly!",
    effects: { shock: 0.65 } },
  ...
  { id: "riftwatch_breach", headline: "Riftwatch reports the Rift 'looking back'. Void-stabilisation contracts pay double!",
